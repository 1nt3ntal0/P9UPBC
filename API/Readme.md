...
import os
~~~
* Inicializacion de la API y declaramos los datos de la DB como variables par migrar rapido cuando se requiera
~~~
app = Flask(__name__)
...
~~~
{
    ...
    "religion": "Católica",
    "Grado": "Alto",
    "Extra": "Información adicional actualizada",
    "Telefono": "987654321"
}
~~~
3. Eliminar paciente
...
- URL: /get_coordenadas?paciente_id=1
* Método: GET

# LOS ENDPOINTS SE MODIFICARAN MAS ADELANTE ES SOLO UNA VERSION PREELIMINAR.
